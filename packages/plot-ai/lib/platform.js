...
export function resolvePlatformPackageName() {
	...
	if (platform === "darwin" && arch === "arm64")
		return "@plot/cli-darwin-arm64";
	if (platform === "darwin" && arch === "x64") return "@plot/cli-darwin-x64";
	if (platform === "linux" && arch === "arm64")
		return "@plot/cli-linux-arm64-gnu";
	if (platform === "linux" && arch === "x64") {
		return isMusl() ? "@plot/cli-linux-x64-musl" : "@plot/cli-linux-x64-gnu";
	}
	if (platform === "win32" && arch === "x64") return "@plot/cli-win32-x64-msvc";
