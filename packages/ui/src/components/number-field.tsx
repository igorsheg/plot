	...
	return (
		<NumberFieldPrimitive.Group
			className={cn(
				...
				"in-data-[size=xs]:rounded-md in-data-[size=xs]:before:rounded-[calc(var(--radius-md)-1px)] in-data-[size=xs]:text-xs in-data-[size=xs]:[&_svg]:size-3",
				className,
			)}
	...
	return (
		<NumberFieldPrimitive.Decrement
			className={cn(
				...
				"in-data-[size=xs]:px-[calc(--spacing(1.5)-1px)] in-data-[size=xs]:rounded-s-[calc(var(--radius-md)-1px)]",
				className,
			)}
	...
	return (
		<NumberFieldPrimitive.Increment
			className={cn(
				...
				"in-data-[size=xs]:px-[calc(--spacing(1.5)-1px)] in-data-[size=xs]:rounded-e-[calc(var(--radius-md)-1px)]",
				className,
			)}
	...
	return (
		<NumberFieldPrimitive.Input
			className={cn(
				...
				"in-data-[size=xs]:h-6 in-data-[size=xs]:px-[calc(--spacing(1.5)-1px)] in-data-[size=xs]:leading-6 sm:in-data-[size=xs]:h-5.5 sm:in-data-[size=xs]:leading-5.5",
				className,
			)}
