...
export function WorkQueue() {
  ...
  useEffect(() => {
    ...
    if (focusedIssueId && !running.some((entry) => entry.issueId === focusedIssueId)) {
    ...
    return (
      <Empty>
        <EmptyHeader>
          ...
          <EmptyDescription>new work will appear here when issues are dispatched</EmptyDescription>
        </EmptyHeader>
      </Empty>
    );
  }
